...
function renderDashboard() {
  ...
  const html = `
    ...
    <div class="quick-actions" style="margin-top: 24px; display: grid; grid-template-columns: repeat(4, 1fr); gap: 16px;">
      <div class="quick-action-card" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 24px; border-radius: 12px; text-align: center; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s;" onclick="showCreateProjectModal()">
        <i class="fas fa-plus-circle" style="font-size: 36px; color: #fff; margin-bottom: 12px; display: block;"></i>
        <div style="color: #fff; font-weight: 600; font-size: 15px;">新建项目</div>
      </div>
      <div class="quick-action-card" style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 24px; border-radius: 12px; text-align: center; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s;" onclick="showCreateTaskModal()">
        <i class="fas fa-tasks" style="font-size: 36px; color: #fff; margin-bottom: 12px; display: block;"></i>
        <div style="color: #fff; font-weight: 600; font-size: 15px;">新建任务</div>
      </div>
      <div class="quick-action-card" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); padding: 24px; border-radius: 12px; text-align: center; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s;" onclick="router.navigate('dailyLog'); renderContent();">
        <i class="fas fa-book" style="font-size: 36px; color: #fff; margin-bottom: 12px; display: block;"></i>
        <div style="color: #fff; font-weight: 600; font-size: 15px;">施工日志</div>
      </div>
      <div class="quick-action-card" style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); padding: 24px; border-radius: 12px; text-align: center; cursor: pointer; transition: transform 0.2s, box-shadow 0.2s;" onclick="router.navigate('afterSale'); renderContent();">
        <i class="fas fa-headset" style="font-size: 36px; color: #fff; margin-bottom: 12px; display: block;"></i>
        <div style="color: #fff; font-weight: 600; font-size: 15px;">售后工单</div>
      </div>
    </div>
