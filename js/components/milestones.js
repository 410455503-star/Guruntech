        ...
        return `
          <div class="card milestone-card" style="padding: 24px;">
            ...
            <div class="milestone-footer" style="display: flex; justify-content: space-between; align-items: center; padding-top: 16px; border-top: 1px solid var(--border-color);">
              <span class="tag tag-${statusClass}">${getMilestoneStatusName(milestone.status)}</span>
            </div>
          </div>
        `;
      }).join('')}
          ...
          <form id="createMilestoneForm">
            ...
            <div class="form-group">
              ...
              <div style="display: flex; flex-wrap: wrap; gap: 6px;">
                <button type="button" class="btn btn-xs" style="background: #e0f2fe; color: #0369a1; border: 1px solid #bae6fd; border-radius: 4px; padding: 4px 10px; font-size: 12px; cursor: pointer;" onclick="setMilestonePreset('施工图设计完成')">施工图设计完成</button>
                <button type="button" class="btn btn-xs" style="background: #e0f2fe; color: #0369a1; border: 1px solid #bae6fd; border-radius: 4px; padding: 4px 10px; font-size: 12px; cursor: pointer;" onclick="setMilestonePreset('土建主体完工')">土建主体完工</button>
                <button type="button" class="btn btn-xs" style="background: #fef3c7; color: #92400e; border: 1px solid #fcd34d; border-radius: 4px; padding: 4px 10px; font-size: 12px; cursor: pointer;" onclick="setMilestonePreset('设备进场验收')">设备进场验收</button>
                <button type="button" class="btn btn-xs" style="background: #fef3c7; color: #92400e; border: 1px solid #fcd34d; border-radius: 4px; padding: 4px 10px; font-size: 12px; cursor: pointer;" onclick="setMilestonePreset('机电安装完成')">机电安装完成</button>
                <button type="button" class="btn btn-xs" style="background: #d1fae5; color: #065f46; border: 1px solid #a7f3d0; border-radius: 4px; padding: 4px 10px; font-size: 12px; cursor: pointer;" onclick="setMilestonePreset('单机调试完成')">单机调试完成</button>
                <button type="button" class="btn btn-xs" style="background: #d1fae5; color: #065f46; border: 1px solid #a7f3d0; border-radius: 4px; padding: 4px 10px; font-size: 12px; cursor: pointer;" onclick="setMilestonePreset('联动调试完成')">联动调试完成</button>
                <button type="button" class="btn btn-xs" style="background: #ede9fe; color: #6d28d9; border: 1px solid #c4b5fd; border-radius: 4px; padding: 4px 10px; font-size: 12px; cursor: pointer;" onclick="setMilestonePreset('工艺调试达标')">工艺调试达标</button>
                <button type="button" class="btn btn-xs" style="background: #ede9fe; color: #6d28d9; border: 1px solid #c4b5fd; border-radius: 4px; padding: 4px 10px; font-size: 12px; cursor: pointer;" onclick="setMilestonePreset('环保验收通过')">环保验收通过</button>
                <button type="button" class="btn btn-xs" style="background: #fce7f3; color: #9d174d; border: 1px solid #f9a8d4; border-radius: 4px; padding: 4px 10px; font-size: 12px; cursor: pointer;" onclick="setMilestonePreset('竣工移交')">竣工移交</button>
              </div>
            </div>
            <div class="form-group">
