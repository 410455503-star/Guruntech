...
function renderContent() {
  ...
  if (contentElement) {
    contentElement.innerHTML = `<div class="page-content">${content}</div>`;
  }
            ...
            return `
              <tr>
                <td>
                  ...
                  <div class="text-muted text-sm">${project.description.substring(0, 50)}...</div>
                </td>
            ...
            return `
              <tr>
                <td>
                  ...
                  <div class="text-muted text-sm">${task.description.substring(0, 50)}...</div>
                </td>
